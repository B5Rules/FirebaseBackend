...
export default function Enter_kwh({ navigation, route }) {
  ...
  const chargeUsingStation = async (kWh) => {
    console.log({
      id: getGlobalState("stationId"),
      status: 1,
      chargekWh: kWh,
    })
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <Text style={styles.title}>
            {" "}
            Introduce number of kwH you want to charge:{" "}
          </Text>
